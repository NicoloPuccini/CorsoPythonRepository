#METODI STATICI
#
#Sono metodi di una classe che possono essere chiamati cenza che esista un'istanza 
#della classe

#Vengono definiti usando il decorator @staticmethod

#I metodi static non possono accedere a self o a cls

#Vedi 16_GDR_Interfaccia _static nella cartella utils per un esempio esteso di utilizzo
